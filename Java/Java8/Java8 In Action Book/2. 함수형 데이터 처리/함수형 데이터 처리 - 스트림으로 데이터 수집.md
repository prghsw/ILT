...
![그룹화 과정](C:\H\공부\java 8 in action\2. 함수형 데이터 처리\images\그룹화 과정.png)
...
![다 수준 그룹화 과정](C:\H\공부\java 8 in action\2. 함수형 데이터 처리\images\다 수준 그룹화 과정.png)
...
![여러 컬렉터 중첩 과정](C:\H\공부\java 8 in action\2. 함수형 데이터 처리\images\여러 컬렉터 중첩 과정.png)
...
![순차 리듀싱 과정의 논리적 순서](C:\H\공부\java 8 in action\2. 함수형 데이터 처리\images\순차 리듀싱 과정의 논리적 순서.png)
...
![병렬화 리듀싱 과정에서 combiner 메서드 활용](C:\H\공부\java 8 in action\2. 함수형 데이터 처리\images\병렬화 리듀싱 과정에서 combiner 메서드 활용.png)
